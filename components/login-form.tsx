...
export function LoginForm({
  ...
  useEffect(() => {
    ...
    setOauthProviders({
      google: !!(process.env.NEXT_PUBLIC_GOOGLE_CLIENT_ID || process.env.GOOGLE_CLIENT_ID),
      apple: !!(process.env.NEXT_PUBLIC_APPLE_CLIENT_ID || process.env.APPLE_CLIENT_ID)
    });
  }, []);
        ...
        <CardContent className="grid p-0 md:grid-cols-2">
          ...
          >
            <div className="flex flex-col gap-6">
              ...
              {/* Only show OAuth section if at least one provider is available */}
              {(oauthProviders.google || oauthProviders.apple) && (
                <>
                  ...
                  <div className={`grid gap-4 ${oauthProviders.google && oauthProviders.apple ? 'grid-cols-2' : 'grid-cols-1'}`}>
